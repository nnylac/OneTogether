...
export function AssignedIncidentTickets({
  incidents,
}: AssignedIncidentTicketsProps) {
  return (
    <Card.Root
      bg="white"
      ...
      <Card.Header>
        <Flex justify="space-between" align="center" gap="4">
          ...
          <ChevronRightLink
            ...
            label="View all incident tickets"
          />
        </Flex>
      </Card.Header>
                  ...
                  >
                    <Stack gap="1">
                      ...
                      <Text color="gray.500" fontSize="sm">
                        ...
                        {incident.severity ??
                          (incident.isCritical ? "Critical" : "Medium")}
                      </Text>
                    </Stack>

                    <DashboardStatusLabel tone={meta.tone}>
                      {meta.label}
